...
def test_http_scope_has_no_later_slice_or_user_management_routes(client):
    ...
    # Keep an exact current-head allowlist: only the authorized Slice 3/4/5/6/7/8 routes
    ...
    assert methods == {
        ...
        ("POST", "/locations"),
        ("GET", "/locations"),
        ("GET", "/locations/{location_id}/path"),
        ("GET", "/assets"),
        ("GET", "/assets/{asset_id}"),
        ...
        ("GET", "/assets/{asset_id}/movements"),
        ("POST", "/assets/{asset_id}/custody-changes"),
        ("GET", "/assets/{asset_id}/custody-changes"),
        ("POST", "/assets/{asset_id}/ownership-changes"),
        ("GET", "/assets/{asset_id}/ownership-changes"),
        ("POST", "/assets/{asset_id}/assignments"),
        ("POST", "/assets/{asset_id}/unassignment"),
        ("GET", "/assets/{asset_id}/assignments"),
        ("POST", "/assets/{asset_id}/configurations"),
        ...
        ("GET", "/purchase-orders/{po_id}/lines"),
        ("PATCH", "/purchase-orders/{po_id}/lines/{line_id}"),
        ("POST", "/purchase-orders/{po_id}/lines/{line_id}/supersede"),
    }
